...
class BarcodeMask extends React.Component {
  ...
  _startLineAnimation = () => {
    const intervalId = setInterval(() => {
      const { finderLayout, intervalId: intervalIdOld } = this.state;
  ...
  _animateLoop = () => {
    const { animatedLineOrientation, lineAnimationDuration, useNativeDriver } = this.props;
  ...
  render() {
    ...
    return (
      <View style={[styles.container]}>
        <View style={[styles.finder, { width, height }]} onLayout={this._onFinderLayoutMeasured}>
